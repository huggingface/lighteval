...
def is_ended_sentence(text: str, translation_literals: TranslationLiterals):
    return text.strip().endswith(
        f"{translation_literals.question_mark}{translation_literals.full_stop}{translation_literals.colon}"
    )


def should_follow_sentence_space(prefix: str, translation_literals: TranslationLiterals):
    return prefix.strip().endswith(
        f"{translation_literals.question_mark}{translation_literals.full_stop}{translation_literals.colon}{translation_literals.comma}"
    )
