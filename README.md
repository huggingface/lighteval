...
You can find the template of the expected model configuration in [examples/model*configs/base_model.yaml*](./examples/model_configs/base_model.yaml).
