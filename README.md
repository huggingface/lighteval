...
Customization at your fingertips: letting you either browse all our existing [tasks](https://huggingface.co/docs/lighteval/available-tasks) and [metrics](https://huggingface.co/docs/lighteval/metric-list) or effortlessly [create your own](https://huggingface.co/docs/lighteval/adding-a-custom-task), tailored to your needs.
